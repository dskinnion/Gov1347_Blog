...
ggsave("figures/Shocks_Model_Arizona.png", height = 4, width = 6)
...
ggsave("figures/Shocks_Model_Michigan.png", height = 4, width = 6)
...
ggsave("figures/Shocks_Model_Ohio.png", height = 4, width = 6)

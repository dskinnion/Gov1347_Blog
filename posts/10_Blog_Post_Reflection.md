...
My refined hypothesis: If states are solid Red States, the polls are going to be worse because there is a base of Trump voters who are anti-government, anti-institutions, and anti-media, and thus going to be less likely to respond to polls. These voters are likely to be in rural areas, which are much more concentrated in Red States. Because the Electoral College intentionally protects these low-population areas and skews the vote in their favor, this helps to explain why the Electoral College can be won by Republicans who do not win the Popular Vote, which has happened in 2000 and 2016.
